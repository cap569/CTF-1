      ...
      <div className="bg-[#181A21]">
        ...
        <footer className="flex items-center justify-center mt-14 pb-28  bg-[#181A21]">
          <div className="w-[300px] flex items-center justify-center flex-col">
            ...
            <Link
              href={"/login"}
              className="cursor-pointer opacity-80 hover:opacity-100 h-8 flex items-center justify-center px-6 bg-linear-to-r from-[#07BFFF] to-[#2D73FF] rounded-sm text-white"
            >
              Entrar agora
            </Link>
          </div>
